...
input parameters.  The failure probability is high when the
...
restructuring; (ii) It fails when the high-order and low-order
...
reach completion due to robustness issues, thereby undermining the
...
\textit{How:} Enforcing physical bounds is usually done in the
...
LANL's ability to leverage more efficiently machine learning and AI tools. 
...
\textit{How much:} The budget asked for the execution of the project
...
feasibility of the proposed approach. Spring 2027 will be dedicated to
testing the theoretical ideas from \citep{Guermond_arxiv_2026} and
demonstrating that the proposed strategy can indeed be
applied non-intrusively on test-bed codes developed by the PIs. This
